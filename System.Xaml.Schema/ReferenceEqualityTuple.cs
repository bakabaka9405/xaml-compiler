...
internal class ReferenceEqualityTuple<T1, T2> : Tuple<T1, T2>
{
	...
	{
		return ((IStructuralEquatable)this).Equals(obj, (IEqualityComparer)ReferenceEqualityComparer<object>.Singleton);
	}

	public override int GetHashCode()
	{
		return ((IStructuralEquatable)this).GetHashCode((IEqualityComparer)ReferenceEqualityComparer<object>.Singleton);
	}
}
